...
Открываем программу Arduino на компьютере, в настройках указываем тип платы (Arduino Nano), выбираем нужный COM порт и заливаем прошивку [Проект]\firmware\MasterStation\MasterStation.ino на плату.
