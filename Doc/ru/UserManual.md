...
### Быстрая подготовки базовой станции
...
- Start/Finish - Включает проверку на чипах участников отметку на стартовой станции во времени отметки участником на базовой станции
- Check InitTime - Включает проверку времени инициализации чипа участника во время отметки участником на базовой станции
- AutoDel Set - Если включено, то возвращает настройки по умолчанию для базовой станции после её перехода в режим сна
- Fast Mark - Включает режим быстрой отметки. При этом сокращается время ожидания участником, когда базовая станция запишет отметку на чипе участника. Но также при этом сокращается ресурс чипов участников и чипы будут быстрее выходить из строя
