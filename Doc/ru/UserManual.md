...
Для прошивок, работающих с чипами Mifare параметры с и d не настраиваются, использую по умолчанию (не проверять время инициализации чипа, число отметок = 42)
