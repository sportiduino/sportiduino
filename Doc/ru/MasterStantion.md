...
[Подробнее про сборку тут](https://github.com/alexandervolikov/sportiduino/master/Doc/ru/MasterStantionAssembly.md)
...
|функция|Команды|длина|Массив данных по байтам ( в скобах адрес в массиве)|
|---|---|---|---|
|0x61|Передача лога|много пакетов|(первый пакет - номер станции (0-1)), номер отметившегося чипа 1(1-2), номер отметившегося чипа 2(3-4),…
