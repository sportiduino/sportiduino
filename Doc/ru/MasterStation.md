...
![](/Master%20station/Scheme.PNG)

Все компоненты схемы можно разместить на печатной плате или всё припаять к Arduino навесным монтажом обычными проводами (рекомендуется провод МГТФ-0,12). Электронику мастер станции можно разместить в корпусе Gainta G1020BF или в специально-разработанном корпусе, который можно распечатать на 3д принтере. [Подробнее про сборку тут](/Doc/ru/MasterStantionAssembly.md)
...
|0x4F|Установить текущий пароль|(0-2) пароль|
