...
Монтаж компонентов проходит на печатной плате, с платой RFID соединение спайкой через штырьковый разъём. Можно заказать изготовление плат в Китае, за партию в 30 плат это обойдётся порядка 50 рублей за штуку с доставкой, гербер файлы есть в папке base station. 

![](https://raw.githubusercontent.com/alexandervolikov/sportiduino/master/Base%20station/PCB.JPG)

Интерфейс реализовал на разъеме PBD-6, 6 контактов в два ряда. В качестве копуса g1020BF. В корпусе сверлится дырка для светодиода и срезается лишний пластик, чтобы влез батарейный отсек.
...
При подносе мастер чипа станция переходит в режим сна (вхождение в сон на 8 секунд), пикает 3 раза и перезагружается. В режиме сна станция интегрально потребляет  0.02 мА. Полностью заряженных батарей хватит на 5 лет. При подносе любого чипа станция переходит в режим ожидания, при этом происходит измерение оставшегося заряда батареи (3 сигнала - заряд меньше 15% ( < 3.2 Вольт), 1 сигнал - заряд больше 15%), затем происходит перезагрузка
...
После перепайки индуктивностей на модуле RC522 возможно их нестабильная работа - прохождение отметки только на определенном расстоянии от антенты. Чтобы исправить это нужно понизить константу gain в прошивке.
...
200, 1 - на чип записана отметка; (ещё один дополнительный световой сигнал на 200 мс)
