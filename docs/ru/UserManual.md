...
**Внимание!**
*Если вы установите новый пароль и забудете его, то для сброса пароля понадобится разборка станции и перезапись настроек по UART.
...
Если после инициализации чипа прошло больше 180 дней, станция не делает отметку и не подаёт сигнал.
...
Усиление антенны по умолчанию 33 дБ.
Если задать максимальное усиление, то в некоторых станциях чипы перестают отмечаться при поднесении их вплотную.
Для станций с этой проблемой нужно постепенно уменьшать усиление до достижения оптимального срабатывания.
